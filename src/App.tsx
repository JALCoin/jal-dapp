...
return ( <header className="site-header"> <div className="header-inner"> <NavLink to="/" onClick={closeMenu} aria-label="JAL/SOL Home"> <img
         src="/JALSOL1.gif"
         alt="JAL/SOL Logo"
...
const origin =
typeof window !== "undefined" ? window\.location.origin : "[https://jalsol.com](https://jalsol.com)";

// Your proxy / RPC selection
const endpoint = useMemo(() => {
if (typeof window !== "undefined" && window\.location.hostname === "localhost") {
return "[http://localhost:3001/api/solana](http://localhost:3001/api/solana)";
}
return "[https://solana-proxy-production.up.railway.app](https://solana-proxy-production.up.railway.app)";
}, \[]);

// Keep adapters on the same cluster
const network =
(import.meta as any).env?.VITE\_SOLANA\_NETWORK === "devnet"
...
\> <WalletModalProvider> <Router> <Shell /> </Router> </WalletModalProvider> </WalletProvider> </ConnectionProvider>
);
}
