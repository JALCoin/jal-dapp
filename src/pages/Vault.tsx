  ...
  return (
    <main className="min-h-screen bg-[var(--jal-bg)] text-[var(--jal-text)] p-6">
      <div className="container">
        <h1 className="text-3xl font-bold text-center">Your Vault</h1>

        {loading ? (
          <p className="text-center mt-4 text-[var(--jal-muted)]">Loading tokens...</p>
        ) : visibleTokens.length === 0 ? (
          <p className="text-center mt-4 text-[var(--jal-muted)]">No tokens found for this wallet.</p>
        ) : (
